        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-12 w-12" src="https://www.huellascallejeras.com/wp-content/uploads/2020/06/logoHuellas3.png"
                alt="Your Company" />
            </div>
              ...
              <Menu as="div" class="relative ml-3">
                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                    ...
                    <a @click='logout' :class="['block px-4 py-2 text-sm text-gray-700 cursor-pointer']">Cerrar
                      Sesión</a>
                    </MenuItem>
                  </MenuItems>
                </transition>
...
const navigation = [
  /* { name: 'Iniciar Sesión', to: { name: Login }},
  { name: 'Registrarse', to: { name: Register }}, */
  /* { name: 'Animales', to: { name: TusMascotasPage }}, */
